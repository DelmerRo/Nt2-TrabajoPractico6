<template lang="html">
  <section class="navigator">
    <button id="reset" @click="init()">{{this.$store.state.restartButton}}</button>
    
    <span class="message" :style="getStyles(this.$store.state.messageDisplay)">
